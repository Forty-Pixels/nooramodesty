...
import { uniqueMessages, validateEmail, validatePassword, validateRequiredText } from "@/utils/formValidation";
...
export default function LoginPage() {
    ...
    const handleSubmit = (event: React.FormEvent) => {
        ...
        const validationErrors = uniqueMessages([
            ...(mode === "register" ? validateRequiredText(fullName, "Full name", { minLength: 2, maxLength: 80 }) : []),
            ...validateEmail(email),
            ...validatePassword(password),
        ]);

        setErrors(validationErrors.length ? validationErrors : ["Account access is not connected yet."]);
    };
        ...
        <div className="min-h-screen bg-[#f6f5f3] flex flex-col items-center justify-center px-6 py-20">
            <div className="w-full max-w-[400px] space-y-12 animate-in fade-in slide-in-from-bottom-4 duration-1000">
                ...
                <form className="space-y-6" onSubmit={handleSubmit} noValidate>
                        ...
                        <div className="space-y-1.5">
                            ...
                            <div className="relative group">
                                ...
                                <input
                                    ...
                                    autoComplete="name"
                                    aria-invalid={errors.some((error) => error.toLowerCase().includes("full name"))}
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                autoComplete="email"
                                aria-invalid={errors.some((error) => error.toLowerCase().includes("email"))}
                                className="w-full bg-white border border-black/5 px-12 py-4 text-xs font-medium text-black focus:outline-none focus:border-black/20 transition-all placeholder:text-gray-400"
                            />
                        </div>
                    </div>
                    ...
                    <div className="space-y-1.5">
                        ...
                        <div className="relative group">
                            ...
                            <input
                                ...
                                aria-invalid={errors.some((error) => error.toLowerCase().includes("password"))}
                    ...
                    {errors.length > 0 && (
                        <div className="border border-[#B21E1E]/20 bg-[#B21E1E]/5 px-4 py-3 text-xs font-bold text-[#B21E1E]" aria-live="polite">
                            {errors.length === 1 ? (
                                <p>{errors[0]}</p>
                            ) : (
                ...
                <div className="space-y-4">
                    ...
                    <div className="w-full">
                        <button type="button" className="w-full flex items-center justify-center gap-3 py-4 px-6 border border-black/5 bg-white hover:bg-gray-50 transition-colors group cursor-pointer">
