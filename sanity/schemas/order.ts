...
export const orderItem = defineType({
  ...
  fields: [
    ...
    defineField({ name: "selectedColorHex", title: "Selected color hex", type: "string" }),
    defineField({ name: "size", title: "Size", type: "string" }),
    defineField({ name: "selectedSize", title: "Selected size (legacy)", type: "string" }),
    defineField({ name: "sku", title: "Selected size SKU", type: "string" }),
    defineField({ name: "customSize", title: "Custom size", type: "boolean", initialValue: false }),
    defineField({ name: "preOrder", title: "Pre-order", type: "boolean", initialValue: false }),
    defineField({ name: "customLength", title: "Custom length", type: "string" }),
    defineField({ name: "customBust", title: "Custom bust", type: "string" }),
    defineField({ name: "customHip", title: "Custom hip", type: "string" }),
    defineField({ name: "customSleeve", title: "Custom sleeve", type: "string" }),
